...
mlp_2 = M.MLP(num_hid=2)
mlp_3 = M.MLP(num_hid=3)

# Train MLPs
mlp_2.fit(train_x, train_y, valid_x, valid_y)
mlp_3.fit(train_x, train_y, valid_x, valid_y)

# Get hidden features
features_2 = mlp_2.get_hidden(valid_x)
features_3 = mlp_3.get_hidden(valid_x)

# Visualize hidden features
plot2d(features_2, valid_y, 'valid')
plot3d(features_3, valid_y, 'valid')
